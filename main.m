...
relative_permitivity = [1, 2.1, 2.56, 3.8, 5.4, 10];
dielectric_strength = [3e6, 60e6, 20e6, 30e6, 200e6, 30e6];
conductivity = [0, 10e-15, 10e-17, 10e-17, 10e-15, 10e-12];
...
function [caps, bdvs] = inputScript(relative_permitivity, dielectric_strength)
    ...
    while(flag == true)
        ...
        GraphLosses(1e-12, dielectric, capacitance*10^-9);
...
function GraphLosses(conductivity, relative_perm, capacitance)
